...
/*
 * A text-based-console simulation in Javascript backed by a yoob.Playfield
 * and a yoob.Cursor.
 *
 * The yoob.TextConsole has no concern for display; in MVC terms it is a
 * "model" and you will need to use a "view" such as yoob.PlayfieldCanvasView
 * or yoob.PlayfieldHTMLView to display it.
 *
 * Create a new yoob.TextConsole object t, then call t.init(80, 25), then call
